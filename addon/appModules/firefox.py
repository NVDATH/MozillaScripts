...
class toolsBarDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.goButton = wx.Button(self, wx.ID_ANY, _("&Go"))
        ...
        self.optionsButton = wx.Button(self, wx.ID_ANY, _("&Options"))
        buttonsSizer.Add(self.optionsButton)
        self.Bind( wx.EVT_BUTTON, self.onOptionsButton, self.optionsButton)
